...
# dataset for recovered cases from github
...
recovered = pd.read_csv(recovered_data)
...
if tab_select == tabs[0]:
    ...
    df_cases['Daily_Cases'] = df_cases[df_cases['Country/Region']
...
if tab_select == tabs[1]:
    ...
    deathInNumber = df_deaths[df_deaths['Country/Region']
    ...
    country_df_deaths = df_deaths_duplicate[df_deaths_duplicate['Country/Region']
                                            == country_select]
